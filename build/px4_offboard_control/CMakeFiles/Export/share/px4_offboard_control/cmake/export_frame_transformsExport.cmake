...
foreach(_expectedTarget px4_offboard_control::frame_transforms)
...
# Create imported target px4_offboard_control::frame_transforms
add_library(px4_offboard_control::frame_transforms SHARED IMPORTED)

set_target_properties(px4_offboard_control::frame_transforms PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/usr/include/eigen3;${_IMPORT_PREFIX}/include/px4_offboard_control;${_IMPORT_PREFIX}/include"
